...
@section('adminlte_css')
    <style>
        ...
        .label-checkbox-custom:hover input ~ .box-checkmark-custom {
            border-color: rgba(99, 102, 241, 0.5);
            background-color: rgba(255, 255, 255, 0.05);
        }

        .label-checkbox-custom input:checked ~ .box-checkmark-custom {
            background-color: #6366f1;
            border-color: #6366f1;
            box-shadow: 0 0 10px rgba(99, 102, 241, 0.4);
        }

        .box-checkmark-custom:after {
            content: "";
            position: absolute;
            display: none;
        }

        .label-checkbox-custom input:checked ~ .box-checkmark-custom:after {
            display: block;
        }

        .label-checkbox-custom .box-checkmark-custom:after {
            left: 5px;
            top: 1px;
            width: 4px;
            height: 8px;
            ...
            <div class="login-form-panel">
                <div class="form-content-box">
                    <div class="form-header-block">
                        <h2>Bienvenido <span class="accent-glow">de nuevo</span></h2>
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group-glow">
                            ...
                            <div class="input-relative-wrapper">
                                ...
                                <input type="email" id="email" name="email" class="input-field-glow" placeholder="Ingresa tu correo electrónico" value="{{ old('email') }}" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group-glow">
                            ...
                            <div class="input-relative-wrapper">
                                ...
                                <input type="password" id="password" name="password" class="input-field-glow" placeholder="Ingresa tu contraseña" required>
                        ...
                        <div class="options-row-flex">
                            <label class="label-checkbox-custom">
                                ...
                                <span class="box-checkmark-custom"></span>
                                Recordarme
                            </label>
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="forgot-pass-url">¿Olvidaste tu contraseña?</a>
                            @endif
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (togglePasswordBtn && passwordInput && eyeIcon) {
                togglePasswordBtn.addEventListener('click', () => {
                    ...
                    // Change eye icon path depending on state
                    if (type === 'text') {
                        eyeIcon.innerHTML = `
